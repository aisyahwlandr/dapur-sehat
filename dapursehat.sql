...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2024 at 02:14 PM
...
(2, 'aisyah', 'bc4198de11411d350ffc03842ba22e80'),
(3, 'wulan', 'd826e9fe4d19cb77231c210f1109d46e'),
(4, 'aisyahwulandari', '2939fddc39837743defe24f6864a428d'),
(5, 'yugen', '7ec02f01f0c3765ce14f088cf79281d2'),
(6, 'sagaraxx', 'b3c41bc55a15744888133a4bbb3b1c04'),
(7, 'pemilikdapursehat', 'a1f371ddc54dce2695b40db17e27044c');
...
CREATE TABLE `orders` (
  ...
  `status` varchar(70) DEFAULT 'Menunggu Bukti Pembayaran'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Viko', '6281818181', 'viko@gmail.com', 'Kampus K Universitas Gunadarma', 'Perumnas 2, Jalan Rama Raya', 'OVO', '2024-06-07 14:54:03', 'Pesanan Diterima Pemesan');
