...
background-image: linear-gradient(90deg, rgba(141, 139, 226, 1), rgba(253, 187, 203, 1));">
    <form id="formLogin" class="form" method="POST" action="">
        ...
        <div class="field">
            ...
            <input type="text" class="input-field" placeholder="E-Mail" autocomplete="off" name="email" required />
        </div>
        <div class="field">
            <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="input-icon">
    ...
    <form id="formRegister" class="form" method="POST" action="">
        ...
        <div class="field">
            ...
            <input type="email" class="input-field" placeholder="E-Mail" autocomplete="off" name="email" required />
        </div>
        <div class="field">
            <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="input-icon">
                <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z">
